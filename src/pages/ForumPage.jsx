...
function ForumPage() {
    ...
    return (
      <div className="w-full min-h-screen pt-32 bg-custom-gradient">
        <Navbar/>
        <div className=" w-4/6 mx-auto flex flex-col font-poppins">
          <div className="top rounded-xl bg-[#FFA13B] py-4 px-6 w-full flex justify-center items-center">
            ...
            <div className="w-3/4 h-3/4 mr-5">
              <input
                className="w-full h-full rounded-md px-4 focus:outline-none active:border-[#FF6934] placeholder:text-gray-500"
                type="text"
                name=""
                id=""
          ...
          <div className="posts flex flex-col justify-between items-center">
            {posts.map((post, index) => (
              <div
                key={index}
                className="post bg-[#FFA13B] opacity-90 rounded-xl mt-5 w-full py-5 px-8 flex justify-between items-center"
              >
                <div className="image rounded-2xl rounded-es-sm overflow-hidden w-1/5">
                  <img className="w-full" src={post.Image} alt="" />
                </div>
                <div className="right w-4/5 h-full py-4 px-10 ">
                  <div className="top flex justify-between items-center">
                    <div className="title text font-bold text-black">
                      {post.Title}
                    </div>
                    <div className="like h-10">
                      <img
                        className={
                          post.likes == true ? "h-full" : "h-full grayscale"
                        }
                        src={Love}
                      />
                    </div>
